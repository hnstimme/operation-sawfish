(function (angular) {
    angular.module('app').config(function ($translateProvider) {
        $translateProvider.translations('de', {
            ...
            VIDEO_DESCRIPTION: 'Diese stummen Filmaufnahmen stammen von der britischen Royal Air Force. Sie zeigen den Luftangriff vom 4. Dezember 1944 auf Heilbronn aus der Perspektive eines Bombers. Der Film dauert 3 Minuten und 26 Sekunden. Er wurde als Beobachtungsfilm aufgenommen. Dazu saßen in einem der Bomber hinter dem Piloten zwei Aufklärer mit Filmkameras. Mit den Aufnahmen wollten die Engländer analysieren, wie erfolgreich ihr Luftangriff war. Der Film ist auch im Heilbronner Haus der Stadtgeschichte zu sehen.',
            SHOW_FULL_VIDEO: 'Film in voller Länge ansehen',

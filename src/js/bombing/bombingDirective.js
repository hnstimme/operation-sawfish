            ...
            link: function (scope, element, attrs, ctrl) {
                ...
                setTimeout(function () {
                    ...
                    angular.extend(scope.timelineDef, {
                        ...
                        12.1: christbaumGroups[4].attr('transform', 'translate(470, 220)', 33000, 'linear'),
                        12.3: christbaumGroups[5].attr('transform', 'translate(640, 210)', 33000, 'linear'),
                        12.5: christbaumGroups[6].attr('transform', 'translate(785, 170)', 33000, 'linear'),
                        35.5: christbaumGroups[1].style('opacity', 0, 9000),
                        35.7: christbaumGroups[2].style('opacity', 0, 9000),
                        35.9: christbaumGroups[3].style('opacity', 0, 9000),
